...
# data set config
__C.DATA.DATASET = "Pylon"
__C.DATA.MAP_FILE_PATH = r'c:\Users\fodrasz\OneDrive\Annotation\IDB_Pylon\pylon_total_output'
...
__C.DATA.NUM_TRAIN_IMAGES = 482
__C.DATA.NUM_TEST_IMAGES = 112
